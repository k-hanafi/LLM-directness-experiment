#!/usr/bin/env python3
"""Build the main classification dashboard from the directness baseline CSV.

10-class taxonomy (1A–1G + 0A, 0B, 0C). Reads outputs/baseline/classified_baseline.csv,
...
CSV_PATH = _PROJECT_ROOT / "outputs" / "baseline" / "classified_baseline.csv"
OUTPUT_PATH = (
